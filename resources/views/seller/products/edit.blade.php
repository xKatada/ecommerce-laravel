...
<div class="page-wrapper">
    ...
    <div class="page-body">
        <div class="container-xl">
            <form action="{{ route('product.update', $product->id) }}" method="POST" id="productForm" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="row mb-3">
                    <div class="col-12">
                        <label class="form-label">Product Name</label>
                        <input type="text" class="form-control @error('product_name') is-invalid @enderror" name="product_name" value="{{ old('product_name', $product->product_name) }}" placeholder="General Secretariat Ayude for A New Day">
                        @error('product_name')
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control @error('product_price') is-invalid @enderror" name="product_price" value="{{ old('product_price', $product->product_price) }}" placeholder="General Secretariat Ayude for A New Day">
                        @error('product_price')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        ...
                        <textarea class="form-control @error('product_desc') is-invalid @enderror" name="product_desc" rows="6" placeholder="Content..">{{ old('product_desc', $product->product_desc) }}</textarea>
                        @error('product_desc')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
